...
@interface CusWebSocketManager ()<SRWebSocketDelegate>
...
@end
@implementation CusWebSocketManager

+ (instancetype)shared{
    static CusWebSocketManager *_instance = nil;
...
- (void)connectServer{
    ...
    _webSocket = nil;
    self.webSocket = [[SRWebSocket alloc] initWithURL:[NSURL URLWithString:@"ws://119.23.136.12:8612"]];
